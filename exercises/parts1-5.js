...
var spaceship = new Spacecraft("Determination", 17500);
console.log("It will take " + spaceship.name + " " + spaceship.getDaysToLocation(kilometersToMars) + " days to get to Mars.");
spaceship.printDaysToLocation(new SpaceLocation_1.SpaceLocation('Mars', kilometersToMars));
spaceship.printDaysToLocation(new SpaceLocation_1.SpaceLocation('the Moon', kilometersToTheMoon));
